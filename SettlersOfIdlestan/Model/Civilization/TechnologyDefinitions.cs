...
public static class TechnologyDefinitions
{
    public static IReadOnlyList<Technology> All { get; } = new Technology[]
    {
        ...
        // Suite de la Nécropole Divine : le coût de Purification des Os Divins croît 10% moins vite
        // avec le nombre d'essences divines déjà collectées depuis la dernière Ascension — l'exposant
        // 1 + N/2 devient 1 + N/2 × 0,9 (voir DivineBones.GetCostMultiplier). La première
        ...
        new(TechnologyId.LiturgieFuneraire,
            ...
            modifiers: new Modifier[] { new(ECategory.DIVINE_BONES_SCALING_REDUCTION, EType.ADDITIVE, 0.1) },
            tier: 12, line: 3),
