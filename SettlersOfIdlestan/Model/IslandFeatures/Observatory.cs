...
/// recherche des routes du Vide, de ×3 sans Observatoire à ×2.4 une fois complet (voir
...
public class Observatory : Monument
{
    ...
    public const double CompletedVoidRouteCostMultiplier = 2.4;
    ...
    /// (aucun effet), puis un pas de 1/<see cref="MaxLevel"/> par niveau jusqu'à ×2.4 une fois
