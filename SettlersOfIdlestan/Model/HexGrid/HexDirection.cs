...
/// <summary>
/// Repr�sente les six directions principales dans une grille hexagonale.
/// Ces directions permettent d'explorer le voisinage des hexagones.
/// 
/// Les d�placements en coordonn�es (q, r) :
/// - W (Ouest) : (-1, 0)
/// - E (Est) : (+1, 0)
/// - NE (Nord-Est) : (0, +1)
/// - SE (Sud-Est) : (+1, -1)
...
public static class HexDirectionUtils
{
    ...
    /// <summary>
    /// Retourne la direction pr�c�dante dans le sens horaire.
    /// </summary>
