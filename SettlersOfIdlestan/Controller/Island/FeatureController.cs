...
public class FeatureController
{
    ...
    private void DiscoverFeatures()
    {
        ...
        foreach (var feature in _features)
        {
            ...
            {
                feature.Found = true;
                bool featureToast = feature.DiscoveredEventType is GameEventType.BanditHideoutDiscovered or GameEventType.DragonDiscovered or GameEventType.MinorDemonDiscovered or GameEventType.VolcanoDiscovered;
