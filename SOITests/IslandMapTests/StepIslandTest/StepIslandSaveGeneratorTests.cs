    ...
    public class FullIslandSaveGeneratorTests
    {
        ...
        public void Rebuild_All_Current_Saves()
        {
            ...
            [
                ...
                (FullIslandScenarios.Island2, 0), (FullIslandScenarios.Island2, 1), (FullIslandScenarios.Island2, 2), (FullIslandScenarios.Island2, 3), (FullIslandScenarios.Island2, 4), (FullIslandScenarios.Island2, 5), (FullIslandScenarios.Island2, 6), (FullIslandScenarios.Island2, 7),
        ...
        public void Rebuild_Release_Summary()
        {
            ...
            // requirement (see FullIslandReleaseTests for details); Points70 onward beyond it will
            ...
            [
                ...
                (FullIslandScenarios.Island2, 0), (FullIslandScenarios.Island2, 1), (FullIslandScenarios.Island2, 2), (FullIslandScenarios.Island2, 3), (FullIslandScenarios.Island2, 4), (FullIslandScenarios.Island2, 6), (FullIslandScenarios.Island2, 7),
