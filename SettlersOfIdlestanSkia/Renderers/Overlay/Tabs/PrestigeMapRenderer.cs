...
public sealed class PrestigeMapRenderer : IGameRenderer
{
    ...
    internal static string FormatModifier(Modifier mod, LocalizationService localization) => mod.Category switch
    {
        ...
        Modifier.ECategory.DOMINION_HARVEST_SPEED_BONUS      => $"+{(int)(mod.Value * 100)}% {localization.Get("prestige_tooltip_dominion_harvest_speed_bonus")}",
        Modifier.ECategory.TEMPLE_DOMINION_LEVEL_BONUS       => localization.GetFormated("prestige_tooltip_temple_dominion_level_bonus", (int)mod.Value),
