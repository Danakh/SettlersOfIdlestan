...
public sealed class PrestigeHistoryRenderer : IDisposable
{
    ...
    /// <summary>
    /// Instantané de l'onglet pour une vue portée par l'hôte : quelles statistiques existent,
    /// lesquelles restent masquées faute d'objet, et quel sous-onglet est disponible.
    /// </summary>
    ...
    private List<StatSectionSnapshot> BuildPrestigeSections(MainGameState state)
    {
        ...
        // Ordre inverse : la course la plus récente en premier.
