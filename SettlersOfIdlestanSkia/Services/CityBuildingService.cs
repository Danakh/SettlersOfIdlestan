...
public class CityBuildingService
{
    ...
    {
        var civ = SelectedCivilization;
        return civ == null ? HarvestController.SeaportGenerationCooldownTicks
            : HarvestController.GetEffectiveSeaportGenerationCooldown(civ, seaport);
    }
    ...
    /// <summary>Nombre de Relais des Aventuriers déjà construits dans la civilisation sélectionnée, pour l'affichage sur la Guilde des Aventuriers.</summary>
    public int CountAdventurersWayposts()
    {
        var civ = SelectedCivilization;
        return civ == null ? 0 : BuildingController.CountAdventurersWayposts(civ);
    }
    ...
    /// <summary>Cooldown effectif de production de Potions de Force de la Hutte d'Alchimie de la ville sélectionnée.</summary>
