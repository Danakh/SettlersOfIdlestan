...
public class GameRuntimeControl : SkiaCanvasControl
{
    ...
    /// reste est ignore volontairement. Ctrl/Maj et Echap sont ecoutes par
    /// <see cref="Views.GameView"/> et non ici : ce controle n'a le focus clavier que tant
    /// qu'aucun controle Avalonia ne l'a pris, ce qu'un simple clic sur un bouton de l'overlay
    /// suffit a faire.
