...
set CONTENT_DIR=install\steamcontent\demo_linux64
...
dotnet publish SettlersOfIdlestanAvalonia.Desktop -c Release -r linux-x64 --self-contained true -p:DemoBuild=true
if errorlevel 1 (
    echo.
...
rem ici, donc compile sans la constante DEMO. Exclu du depot par depot_build_demo_linux.vdf.
